...
public class AgregarProductoCredito extends JFrame {
	...
	public AgregarProductoCredito(int num) {
		this.setTitle("Venta Credito");
		...
		JLabel lblNewLabel_6 = new JLabel("entidadFinanciera");
		lblNewLabel_6.setBounds(52, 212, 119, 14);
		...
		btnNewButton_2.setBounds(10, 238, 119, 23);
		contentPane.add(btnNewButton_2);
		btnNewButton_2.setEnabled(false);
		
		JButton btnNewButton = new JButton("agregarProductos");
		btnNewButton.setBounds(152, 238, 173, 23);
